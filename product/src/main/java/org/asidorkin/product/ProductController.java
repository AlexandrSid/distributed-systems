...
//            , ignoreExceptions = {HystrixRuntimeException.class, HystrixTimeoutException.class}
    ...
    public ItemAvailabilityDTO availableById(@PathVariable String id) {
        ...
        return productService.constructAndReturnItemAvailabilityDTO(requestedByIdItem, idToAvailableValues, filterZeros);
    }
...
//            , ignoreExceptions = {HystrixRuntimeException.class, HystrixTimeoutException.class}
    ...
    public String stringBySku(@PathVariable String sku) {
        ...
        return productService.convertResponse2String(itemAvailabilityDTO);
    }
    ...
    public ItemAvailabilityDTO getFallback(String string, Throwable e) {
